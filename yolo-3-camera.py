...
# for Windows, yours paths might look like: r'yolo-coco-data\yolov3.cfg' r'yolo-coco-data\yolov3.weights' or: 'yolo-coco-data\\yolov3.cfg' 'yolo-coco-data\\yolov3.weights'
